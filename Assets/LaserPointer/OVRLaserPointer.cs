...
public class OVRLaserPointer : OVRCursor
{
    ...
    private static OVRLaserPointer _instance;
    public static OVRLaserPointer instance
    {
        ...
        get
        {
            if (_instance == null)
            {
                ...
                _instance = (OVRLaserPointer)GameObject.Instantiate((OVRLaserPointer)Resources.Load("Prefabs/GazePointerRing", typeof(OVRLaserPointer)));
            }
            return _instance;
        }
